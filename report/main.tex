...
For the objective measure we computed a two-sided t-test to compare the results for both sound engines. Analysis revealed that with the ... sound engine participants were significantly faster to locate the sound source (t(df) = 2.84, p = 0.01.). 
