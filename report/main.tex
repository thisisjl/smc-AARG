...
First, a monaural sound source is processed by a distance model, which will feed a head model and a room model in parallel. The head models stereo output is input to a pinna echoes model, whose output is added to the output of the room model to obtain the spatialized version of the sound.
