...
Evaluation of the questionnaires, Table \ref{table:questionnairetable}, showed that the mean values for questions 1, 2, 3 and 4 for the 3D model were significantly different from the panning.
...
Summing the results for these first four questions in order to obtain an overall result between the two conditions, the Shapiro-Wilk test showed that the data was normally distributed both for the 3D model (W(10) = 0.933, p = 0.44) and the Panning model (W(10) = 0.95, p = 0.67). Given that, a Paired sample Student t-test was conducted, but significant difference between models was not found (t(10) = 1.05, p = 0.32).
...
1 - 4      & 23.73  & 21.64  & 3.72    & 5.45    & 24  & 21\\
