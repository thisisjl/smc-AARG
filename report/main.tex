...
Finally, we believe that there is an expectation to hear the sounds coming from the device. That means subjects already knew that the sound will play from the headphones and not from a location in the real world. 
