...
public class OFAndroid {
	...
	//new method added for angle orientation
	public static void setupOrientation(){
		if(orient==null)
			orient = new OFAndroidOrientation((SensorManager)ofActivity.getSystemService(Context.SENSOR_SERVICE));
	}
    ...
    private static OFAndroidOrientation orient;
